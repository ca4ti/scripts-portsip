...
if resp.status_code != 200:
	...
	portsip = "https://ippabx:8887/api/tenants"
	headers = {
	'Content-Type': 'application/json',
	...
	for tenant in range(len(tenants['items'])):
		...
		portsip = "https://ippabx:8887/api/tenants/switch?id="+tenants['items'][tenant]['id']+""
		headers = {
		'Content-Type': 'application/json',
		'Authorization': 'Bearer '+auth_continue['access_token']
		}
		...
		portsip = "https://ippabx:8887/api/users"
		headers = {
		'Content-Type': 'application/json',
		'Authorization': 'Bearer '+auth_continue['access_token']
		}
